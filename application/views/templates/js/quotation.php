  ...
  columns: [
	...
	{data: "status_desc",		className: "text-left"},
	{
	  ...
	  render: function(data, type, row){
		return '<a href="quotation/update/' + data + '" class="btn btn-info btn-xs fa fa-edit"></a>&nbsp;<a href="quotation/delete/' + data + '" class="btn btn-danger btn-xs" onclick="return confirm(\'Anda yakin ingin menghapus data ini ?\')"><i class="fa fa-trash"></i></a>';
	  }
	}
