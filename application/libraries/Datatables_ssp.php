...
class Datatables_ssp
{
    ...
    static function sql_connect($sql_details)
    {
        try {
            ...
            $db = @new PDO(
                    "mysql:host={$sql_details['host']};port={$db_port};dbname={$sql_details['db']};charset=UTF8", $sql_details['user'], $sql_details['pass'], array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION)
            );
