				...
				<tbody>
				  <?php foreach($recent_invoice as $row) { ?>
					<tr>
					  ...
					  <td align="right"
						<?php if(($row->invoice_total - $row->invoice_profit) < 0) { ?>
						  class="text-danger"
						<?php } else { ?>
						  class="text-success"
						<?php } ?>
          ...
          <div class="col-md-4 col-6">
			<div class="description-block border-right">
			  ...
			  <?php } ?>
				...
				<?php echo round((($invoice_per_day->invoice_total - $invoice_yesterday->invoice_total) / $invoice_yesterday->invoice_total) * 100, 2) ?> %
			  </span>
          ...
          <div class="col-md-4 col-6">
            <div class="description-block border-right">
			  ...
			  <?php } ?>
				...
				<?php echo round((($invoice_per_day->invoice_total - $profit_per_day->invoice_profit) - ($invoice_yesterday->invoice_total - $profit_yesterday->invoice_profit)) / ($invoice_yesterday->invoice_total - $profit_yesterday->invoice_profit) * 100, 2) ?> %
			  </span>
